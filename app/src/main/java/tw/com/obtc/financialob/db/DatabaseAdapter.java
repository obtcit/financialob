...
import tw.com.obtc.financialob.rates.*;
...
import static tw.com.obtc.financialob.db.DatabaseHelper.SmsTemplateColumns.*;
import static tw.com.obtc.financialob.utils.StringUtil.generateQueryPlaceholders;
...
public class DatabaseAdapter extends MyEntityManager {
    ...
    public void restoreSystemEntities() {
        ...
        try {
            ...
            Log.e("financialob", "Unable to restore system entities", e);
        } finally {
            db.endTransaction();
        }
    }
