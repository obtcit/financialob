...
import static tw.com.obtc.financialob.activity.RequestPermission.isRequestingPermissions;
import tw.com.obtc.financialob.backup.Backup;
import tw.com.obtc.financialob.bus.GreenRobotBus_;
import tw.com.obtc.financialob.db.DatabaseAdapter;
import tw.com.obtc.financialob.export.BackupExportTask;
import tw.com.obtc.financialob.export.BackupImportTask;
import tw.com.obtc.financialob.export.Export;
import tw.com.obtc.financialob.export.csv.CsvExportOptions;
import tw.com.obtc.financialob.export.csv.CsvExportTask;
import tw.com.obtc.financialob.export.csv.CsvImportOptions;
import tw.com.obtc.financialob.export.csv.CsvImportTask;
import tw.com.obtc.financialob.export.qif.QifExportOptions;
import tw.com.obtc.financialob.export.qif.QifExportTask;
import tw.com.obtc.financialob.export.qif.QifImportOptions;
import tw.com.obtc.financialob.export.qif.QifImportTask;
import tw.com.obtc.financialob.utils.EntityEnum;
import tw.com.obtc.financialob.utils.EnumUtils;
import static tw.com.obtc.financialob.utils.EnumUtils.showPickOneDialog;
import tw.com.obtc.financialob.utils.ExecutableEntityEnum;
import tw.com.obtc.financialob.utils.IntegrityFix;
import tw.com.obtc.financialob.utils.SummaryEntityEnum;
...
public enum MenuListItem implements SummaryEntityEnum {
    ...
    GOOGLE_DRIVE_BACKUP(R.string.backup_database_online_google_drive, R.string.backup_database_online_google_drive_summary, R.drawable.actionbar_google_drive) {
        ...
        public void call(Activity activity) {
            ...
            Log.i("nio","開始連線 google 雲端硬碟");
            GreenRobotBus_.getInstance_(activity).post(new tw.com.obtc.financialob.activity.MenuListActivity.StartDriveBackup());
        }
    },
