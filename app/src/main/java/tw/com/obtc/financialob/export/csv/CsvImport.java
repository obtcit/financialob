...
import tw.com.obtc.financialob.export.ProgressListener;
    ...
    private void importTransactions(List<CsvTransaction> transactions,
        ...
        try {
            ...
            for (CsvTransaction transaction : transactions) {
                ...
                if (++count % 100 == 0) {
                    Log.i("financialob", "Inserted " + count + " out of " + totalCount);
                    if (progressListener != null) {
                        progressListener.onProgress((int) (100f * count / totalCount));
                    }
                }
            }
            Log.i("financialob", "Total transactions inserted: " + count);
