...
import tw.com.obtc.financialob.model.MultiChoiceItem;
import tw.com.obtc.financialob.model.MyEntity;
import tw.com.obtc.financialob.utils.ArrUtils;

import static tw.com.obtc.financialob.activity.CategorySelector.SelectorType.FILTER;
import static tw.com.obtc.financialob.blotter.BlotterFilter.CATEGORY_LEFT;
import static tw.com.obtc.financialob.blotter.BlotterFilter.LOCATION_ID;
import static tw.com.obtc.financialob.blotter.BlotterFilter.PAYEE_ID;
import static tw.com.obtc.financialob.blotter.BlotterFilter.PROJECT_ID;
import static tw.com.obtc.financialob.filter.WhereFilter.Operation.BTW;
import static tw.com.obtc.financialob.filter.WhereFilter.Operation.IN;
    ...
    protected void updateCategoryFromFilter() {
        ...
        if (c != null) {
            if (c.operation != BTW) { // todo.mb: only for backward compatibility, just remove in next releases
                Log.i("financialob", "Found category filter with deprecated op: " + c.operation);
