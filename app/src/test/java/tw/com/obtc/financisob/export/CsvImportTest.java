...
import tw.com.obtc.financialob.export.csv.CsvImport;
import tw.com.obtc.financialob.export.csv.CsvImportOptions;
import tw.com.obtc.financialob.export.csv.CsvTransaction;
...
public class CsvImportTest extends AbstractImportExportTest {
    ...
    private void doImport(String csv, CsvImportOptions options) throws Exception {
        ...
        w.write(csv);
        w.close();
        Log.d("financisob", "Created a temporary backup file: " + tmp.getAbsolutePath());
