...
import tw.com.obtc.financialob.adapter.async.SmsTemplateListAsyncAdapter;
import tw.com.obtc.financialob.adapter.async.SmsTemplateListSource;
import tw.com.obtc.financialob.adapter.dragndrop.SimpleItemTouchHelperCallback;
...
public class SmsDragListActivity extends AppCompatActivity {
    ...
    private static final String TAG = "financialob." + SmsDragListActivity.class.getSimpleName();
