...
import tw.com.obtc.financialob.utils.*;

import java.io.*;
import java.util.*;

import static tw.com.obtc.financialob.activity.CategorySelector.SelectorType.TRANSACTION;
import static tw.com.obtc.financialob.utils.Utils.isNotEmpty;
...
public class TransactionActivity extends AbstractTransactionActivity {
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        Log.d("financialob", "onSaveInstanceState");
        try {
            if (categorySelector.isSplitCategorySelected()) {
                Log.d("financialob", "Saving splits...");
            ...
            Log.e("financialob", "Unable to save state", e);
        }
    }
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        Log.d("financialob", "onRestoreInstanceState");
            ...
            try {
                try (ByteArrayInputStream s = new ByteArrayInputStream(bytes)) {
                    ...
                    if (state.categoryId == Category.SPLIT_CATEGORY_ID) {
                        Log.d("financialob", "Restoring splits...");
                ...
                Log.e("financialob", "Unable to restore state", e);
            }
        }
    }
