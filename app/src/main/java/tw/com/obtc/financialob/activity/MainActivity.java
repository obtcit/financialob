...
import tw.com.obtc.financialob.dialog.WebViewDialog;
...
public class MainActivity extends TabActivity implements TabHost.OnTabChangeListener {
    ...
    private void initialLoad() {
        ...
        Log.d("financialob", "Load time = " + (t4 - t0) + "ms = " + (t2 - t1) + "ms+" + (t3 - t2) + "ms+" + (t4 - t3) + "ms");
    }
    ...
    public void onTabChanged(String tabId) {
        Log.d("financialob", "About to update tab " + tabId);
        long t0 = System.currentTimeMillis();
        refreshCurrentTab();
        long t1 = System.currentTimeMillis();
        Log.d("financialob", "Tab " + tabId + " updated in " + (t1 - t0) + "ms");
    }
