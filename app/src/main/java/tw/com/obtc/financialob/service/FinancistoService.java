 ...
 ******************************************************************************/
package tw.com.obtc.financialob.service;
...
import tw.com.obtc.financialob.activity.AbstractTransactionActivity;
import tw.com.obtc.financialob.activity.AccountWidget;
import tw.com.obtc.financialob.activity.MassOpActivity;
...
import tw.com.obtc.financialob.recur.NotificationOptions;
import static tw.com.obtc.financialob.service.DailyAutoBackupScheduler.scheduleNextAutoBackup;
import static tw.com.obtc.financialob.service.SmsReceiver.SMS_TRANSACTION_BODY;
import static tw.com.obtc.financialob.service.SmsReceiver.SMS_TRANSACTION_NUMBER;
import tw.com.obtc.financialob.utils.MyPreferences;
import static tw.com.obtc.financialob.utils.MyPreferences.getSmsTransactionStatus;
import static tw.com.obtc.financialob.utils.MyPreferences.shouldSaveSmsToTransactionNote;
...
public class FinancistoService extends JobIntentService {
    ...
    public static final String ACTION_SCHEDULE_ALL = "tw.com.obtc.financialob.SCHEDULE_ALL";
    public static final String ACTION_SCHEDULE_ONE = "tw.com.obtc.financialob.SCHEDULE_ONE";
    public static final String ACTION_SCHEDULE_AUTO_BACKUP = "tw.com.obtc.financialob.ACTION_SCHEDULE_AUTO_BACKUP";
    public static final String ACTION_AUTO_BACKUP = "tw.com.obtc.financialob.ACTION_AUTO_BACKUP";
    public static final String ACTION_NEW_TRANSACTION_SMS = "tw.com.obtc.financialob.NEW_TRANSACTON_SMS";
        ...
        if (number != null && body != null) {
            ...
            if (t != null) {
                ...
                if (transactionInfo != null) {
                    ...
                    Log.e("financialob", "Transaction info does not exist for "+t.id);
                }
            }
        }
    }
