...
public class Dropbox {
        ...
        try {
            ...
            if (startedAuth && authToken != null) {
                try {
                    ...
                    Log.i("financialob", "Error authenticating Dropbox", e);
                }
            }
        } finally {
            startedAuth = false;
    ...
    public void deAuth() {
        ...
        if (dropboxClient != null) {
            try {
                ...
                Log.e("financialob", "Unable to unlink Dropbox", e);
            }
        }
    }
    ...
    private boolean authSession() {
        ...
        if (accessToken != null) {
            if (dropboxClient == null) {
                DbxRequestConfig requestConfig = DbxRequestConfig.newBuilder("financialob")
        ...
        if (authSession()) {
            try {
                ...
                try {
                    ...
                    Log.i("financialob", "Dropbox: The uploaded file's rev is: " + fileMetadata.getRev());
                    return fileMetadata;
                } finally {
                    IOUtil.closeInput(is);
                }
            } catch (Exception e) {
                Log.e("financialob", "Dropbox: Something wrong", e);
